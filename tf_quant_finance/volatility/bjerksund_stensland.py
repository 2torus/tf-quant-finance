...
"""
    forwards = tf.iconvert_to_tensor(forwards, dtype=dtype, name='forwards')
    ...
    dividend_for_calls = tf.where_v2(is_call_options, dividends, discount_factors)
    discount_for_calls = tf.where_v2(is_call_options, discount_factors, dividends)
    ...
    term1 = ((boundary - K)
            ...
            * (1 - _phi(S, T, beta, boundary, boundary, r, b, volatilities, dtype)))
